...
import { sizeHeight, sizePadding } from '../utils/sizeUtils';
...
const SafeAreaContainer: React.FC<ContainerProps> = ({ children, style, safeStyle, edges }) => (
  <SafeAreaView edges={edges} style={safeStyle ? safeStyle : { flexGrow: 1, backgroundColor: theme.color.black }}>
...
export { SafeAreaContainer, Row, Column, PositionAbsolute, CenterView, Footer, Line };
